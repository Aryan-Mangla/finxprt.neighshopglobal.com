  ...
  return (
    <section className="feVerifyPage" aria-label="Verify your details">
      ...
      <button type="button" className="feVerifyPage__back" onClick={() => onBack?.()} aria-label="Back">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="feVerifyInfo">
        <strong>i</strong>
        <span>Your Credit score is fetched from Bureau. This is a soft inquiry and won&apos;t affect your credit score.</span>
      </div>

      <label className="feVerifyConsent">
        <input type="checkbox" checked={consent} onChange={(e) => setConsent(e.target.checked)} />
        <span>
          I hereby provide my explicit consent to <strong>Experian Credit Information Company of India Pvt. Ltd.</strong> to access and provide my credit information to <strong>Accio Finserv Pvt Limited (CredFix)</strong> for the purpose of enabling you to check and monitor your credit information and credit score, and to receive offers for relevant financial products and services. I confirm that I have read and understood the <button type="button">terms and conditions</button>.
        </span>
      </label>
      ...
      {error ? <p className="feVerifyError">{error}</p> : null}

      <button type="button" className="feLoginPage__cta" disabled={!canSubmit} onClick={submit}>
        Verify &amp; Fetch Score
      </button>
    </section>
  )
